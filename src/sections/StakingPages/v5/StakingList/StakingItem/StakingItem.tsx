...
const StakingItem = ({ title, icon, apy, tvl, minimumLocked, stake, Rewards, amountStaked, balance }: any) => {
        ...
        <div className='staking_flip_card_front'>
          ...
          <div className='staking_flip_card_front_body'>
            <ul className='staking_flip_card_front_list'>
              <li>
                <span>TVL</span> <strong>{tvl} BUSD</strong>
              </li>
              <li>
                <span>Minimum Locked</span> <strong>{minimumLocked} BUSD</strong>
              </li>
              <li>
                <span>LP Staked</span> <strong>{stake} BUSD</strong>
              </li>
            </ul>
            ...
            <div className='staking_flip_card_back_body'>
              ...
              <div className='staking_flip_card_back_body_top'>
                <div className='staking_flip_card_front_list'>
                  <ul>
                    <li>
                      <span>LP Amount staked</span> <strong>{amountStaked} BUSD</strong>
                    </li>
                    <li>
                      <span>Balance</span> <strong>{balance} BUSD</strong>
                    </li>
                  </ul>
                </div>
