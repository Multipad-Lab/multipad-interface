        ...
        <div className='contact_user_form'>
          <form>
            ...
            <div className='input_field_wrapper form-group col-md-12'>
              ...
              <input type='email' id='email' placeholder='e.g.  example@gmail.com' className='form-control' />
            </div>
            <div className='input_field_wrapper form-group col-md-12'>
              <label htmlFor='phone'>Phone (Optional)</label>
              <input type='text' id='phone' placeholder='e.g. +855 2586 25866' className='form-control' />
            </div>
            <div className='input_field_wrapper form-group col-md-12'>
