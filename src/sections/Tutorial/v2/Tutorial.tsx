...
import data from "src/assets/data/tutorial/dataV2"
import earthThumb from "src/assets/images/icons/earthBg.svg"
import lockerThumb from "src/assets/images/icons/locker-dynamic-color.png"
...
const Tutorial = () => {
  return (
    <TutorialStyleWrapper>
      ...
      <img className='img-fluid bg_shape earth_thumb' src={earthThumb} alt='img'></img>
      <img className='img-fluid bg_shape locker_thumb' src={lockerThumb} alt='img'></img>
    </TutorialStyleWrapper>
  )
}
