      ...
      <div className='kyc_form'>
        ...
        <div className={`kyc_country_dropdown_sect ${isContryList ? "active" : ""}`}>
          <div className='kyc_country_dropbox' onClick={() => setCountryList(!isContryList)}>
            <span>
              <img src={flagIcon} alt='flag' className='img-fluid' />
            </span>
            <h4>United States</h4>
          </div>
        ...
        <div className='kyc_radio_sect'>
          <div
            className={`kyc_radio_btn ${isChecked.id === "nid" ? "active" : ""} `}
            id='nid'
          ...
          <div
            className={`kyc_radio_btn ${isChecked.id === "passport" ? "active" : ""} `}
            id='passport'
            onClick={(e) => handleChecked(e)}
          >
            <label>
              PASSPORT
              <input type='radio' checked name='radio' onChange={(e) => handleChecked(e)} id='passport' />
              <span className='checkmark'>
                <FiCheck />
              </span>
            </label>
          ...
          <div
            className={`kyc_radio_btn ${isChecked.id === "driverLicence" ? "active" : ""} `}
            id='driverLicence'
            onClick={(e) => handleChecked(e)}
          >
            <label>
