      ...
      <div className='project_content_right'>
        ...
        <div className='project_meta'>
          <div className='project_fund'>
            <h3>
              Total Raised :{" "}
              <Counter end={totalRised} decimal='.' decimals={totalRised % 1 !== 0 ? "2" : "0"} suffix='' /> /{" "}
              <Counter end={totalValue} decimal='.' decimals={totalValue % 1 !== 0 ? "2" : "0"} suffix='' />
            </h3>
            <span className='counter'>
              <Counter end={progress} decimal='.' decimals={progress % 1 !== 0 ? "2" : "0"} suffix='%' />
            </span>
          </div>
          ...
          <ul className='project_feature_list'>
            {projectFeatures?.map((item: any, i: number) => (
              <li key={i}>
          ...
          <div className='project_social_links'>
            {socialLinks?.map((profile: any, i: number) => (
